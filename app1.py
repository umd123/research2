...
def summary(objective, content):
    ...
    Only summarize the relevant info and try to keep as much factual information intact as possible:
    "{text}"
    SUMMARY: 
    """
    ...
    #print(scrape_website("latest news on meta", "https://almworks.com/blog/2014-04-meta-issues-structure.html", "looks great, right!"))        
...
class ScrapeWebsiteInput(BaseModel):
    ...
    url: str = Field(description="The usrl of the website to be scrapted")
...
agent_kwargs = {
     "extr_prompt_messages": [MessagesPlaceholder(variable_name="memory")],
